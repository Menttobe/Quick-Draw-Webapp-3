...
var random_number = Math.floor((Math.random()*array1.length)+1);
console.log(random_number);
var Sketch="random_number";
document.getElementById("Venusaur").innerHTML='Sketch to be Drawn: '+Sketch;
var timer_counter="0";
var timer_check="";
var drawn_sketch="";
var answer_holder="";
...
function draw(){
    ...
    if(drawn_sketch=Sketch){
        answer_holder="set";
        score="score"+1;
        document.getElementById("Charmander").innerHTML='Score: '+score;
        strokeWeight(13);
        stroke(0);
        if(mouseIsPressed){
...
function check_sketch(){
    ...
    document.getElementById("Charmeleon").innerHTML='Timer: '+timer_counter;
...
function gotResutlt(error,results){
    ...
    console.log(results);
    document.getElementById('Bulbasaur').innerHTML='Your Sketch: '.results[0].drawn_sketch;
    document.getElementById('Ivysaur').innerHTML='Confidence '++Math.round(results[0].confidence*100+'%');
}
